    ...
    return (
        <>
            <div className=" button-blue pt-5 pb-5 flex justify-center">
                <div>
                    <div className="logo text-center" style={{display:"flex",justifyContent:"center"}}>
                        <img src={logo} style={{width:"85px"}} alt="a"/>
                    </div>
                    <ul className="mt-5 flex font-bold items-center sm:gap-5 gap-2 flex-wrap justify-center text-white text-base">
                        <li>Blog</li>
                        <li>FAQs</li>
                        <li>Contect Us</li>
        ...
        <div>
            <div className="how">
                <div className="container mx-auto  flex p-3 flex-wrap sm:justify-between justify-center gap-3 items-center">
                    <h1 className="text-white text-xs font-semibold text-center ">Tkex Copyright 2022 all rights reserved</h1>
